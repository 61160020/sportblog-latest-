  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        <!-- <li class="nav-item">
          <a class="nav-link" href="index2.php"><font color="#FFCC00">บทความของฉัน <i class='fas fa-book-open' style='font-size:24px'></i></font></i></a>
        </li> -->
        <li class="nav-item">
          <a class="nav-link" href="login.php"><font color="#FFCC00">Login <i class='fas fa-address-book' style='font-size:24px'></font></i></a>
        </li>
      </ul>
    </div>
  </div>
